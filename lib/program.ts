...
export const PROGRAM_MODULO_TITLES: Record<number, string> = {
  ...
  2: 'Módulo 2 · Neutrófilos, urgencias y dismorfias',
...
export const PROGRAM_SLOTS: ProgramSlot[] = [
  ...
  },
  {
    numero: 6,
    modulo: 2,
    ponente: 'Dra. Evelyn Silva Contreras',
    cargo: 'Inmunóloga - Hospital de Talca',
    titulo: 'Urgencias Inmunológicas: Inmunodeficiencia Combinada Severa',
    match: [/\b0?6\b/, /evelyn/i, /silva/i],
  },
  {
    numero: 7,
    modulo: 2,
    ...
    match: [/\b0?7\b/, /ligia/i, /rodr[ií]guez/i],
  },
  {
    numero: 8,
    modulo: 2,
    ...
    match: [/\b0?8\b/, /mervin/i, /pi[nñ]ones/i],
  },
  {
    numero: 9,
    modulo: 3,
    ...
    match: [/\b0?9\b/, /patricia/i, /vergara/i],
  },
  {
    numero: 10,
    modulo: 3,
    ...
    match: [/\b10\b/, /nicol[aá]s/i, /fa[uú]ndes/i],
  },
  {
    numero: 11,
    modulo: 3,
    ...
    match: [/\b11\b/, /ilenne/i, /d[ií]az/i],
  },
  {
    numero: 12,
    modulo: 3,
    ...
    match: [/\b12\b/, /lurimar/i, /manrique/i],
  },
  {
    numero: 13,
    modulo: 4,
    ...
    match: [/\b13\b/, /pamela/i, /m[eé]ndez/i],
  },
  {
    numero: 14,
    modulo: 4,
  ...
  },
  {
    ...
    match: [/\b15\b/, /fabiola/i, /fern[aá]ndez/i],
  },
  {
    numero: 16,
    modulo: 4,
    ...
    match: [/\b16\b/, /alfonso/i, /hern[aá]ndez/i],
  },
]
